...
(defgeneric setup-package-source (source project)
  (:documentation "Run the setup steps for the package source"))
...
(defun download-dependencies (project source-registry-param)
  ...
  (setup-package-source (project-config-package-source project) project)
